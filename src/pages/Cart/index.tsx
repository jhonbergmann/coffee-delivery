...
import {IFormInputs, newOrder} from './data'
import {
  AddressContainer,
  AddressForm,
  AddressHeading,
...
export function Cart() {
  ...
  const handleOrderCheckout: SubmitHandler<IFormInputs> = (data) => {
    if (cart.length === 0) {
          ...
          <PaymentContainer>
            ...
            <PaymentOptions>
              ...
              {errors.paymentMethod ? (
                <PaymentErrorMessage role="alert">{errors.paymentMethod.message}</PaymentErrorMessage>
              ) : null}
            </PaymentOptions>
          </PaymentContainer>
        </form>
